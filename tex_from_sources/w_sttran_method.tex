...
\paragraph{Phase 1: Token Formation.} For each human-object pair $(p, o)$, a relationship token is formed by concatenating the node features, union region-of-interest features $\mat{u}_{po}$, and projected CLIP text embeddings $\mat{t}_p, \mat{t}_o$ representing the object classes:
\begin{equation}
