...
def cmd_run(a):
    ...
    cfg = FusionConfig(arm=a.arm, mode=a.mode, edge_decay=a.edge_decay, lambda_birth=a.lambda_birth,
                       observed_readout=a.observed_readout, prior_on_observed=not a.no_prior_on_observed,
...
def main():
    ...
    r.add_argument("--observed-readout", default="frame", choices=["frame", "track", "slot"])
    r.add_argument("--no-prior-on-observed", action="store_true")
