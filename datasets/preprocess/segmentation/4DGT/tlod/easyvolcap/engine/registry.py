...
from .config import APPEND_KEY, BASE_KEY, Config, DELETE_KEY, DEPRECATION_KEY
...
def build_from_cfg(
    cfg: Dict, registry: "Registry", default_args: Optional[Dict] = None, **kwargs
) -> Any:
