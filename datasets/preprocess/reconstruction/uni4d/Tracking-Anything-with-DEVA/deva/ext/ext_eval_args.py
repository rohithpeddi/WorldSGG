...
def add_ext_eval_args(parser: ArgumentParser):
    ...
    parser.add_argument('--DINO_THRESHOLD', default=0.3, type=float)
    ...
    parser.add_argument('--SAM2_CHECKPOINT_PATH', default='./saves/sam2.1_hiera_large.pt')
...
def add_text_default_args(parser):
    ...
    parser.add_argument('--sam_variant', default='sam2', help='mobile/original')
    return parser
