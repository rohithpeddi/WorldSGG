"""
LKS Buffer Configuration
==========================

Config for the Last-Known-State (LKS) Buffer baseline.
Sequential processing, no BPTT, no masking, no contrastive loss.
"""
...
class LKSConfig:
    ...
    def setup_parser() -> ArgumentParser:
        parser = ArgumentParser(description="LKS Buffer baseline training")
        ...
        parser.add_argument("--method_name", default="lks_buffer", type=str)
